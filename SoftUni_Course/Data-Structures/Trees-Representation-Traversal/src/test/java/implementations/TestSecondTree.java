...
public class TestSecondTree {
    ...
    public void testTreeCreation() {
        ...
        SecondTree<Integer> tree = treeFactory.createTreeFromStrings(input);
    ...
    public void testDeepestLeftmostNode() {
        ...
        SecondTree<Integer> deepestLeftmostNode = tree.getDeepestLeftmostNode();
    ...
    public void testTreesWithGivenSum() {
        ...
        TreeFactory treeFactory = new TreeFactory();
        SecondTree<Integer> tree = treeFactory.createTreeFromStrings(input);
        List<SecondTree<Integer>> trees = tree.subTreesWithGivenSum(43);
